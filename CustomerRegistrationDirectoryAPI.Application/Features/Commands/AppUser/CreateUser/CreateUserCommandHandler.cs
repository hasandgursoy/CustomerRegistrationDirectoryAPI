...
using P = CustomerRegistrationDirectoryAPI.Domain.Entities.Identity;
namespace CustomerRegistrationDirectoryAPI.Application.Features.Commands.AppUser.CreateUser
{
